...
module.exports = {
  "content": [
    ...
    [
      ...
      ", 是 react-map的核心组件，其他所有组件必须依赖此组件。"
    ],
    [
      "h2",
      "怎么使用"
    ...
    [
      ...
      {
        "lang": "bash",
        "highlighted": "$ <span class=\"token function\">import</span> <span class=\"token punctuation\">{</span> Map <span class=\"token punctuation\">}</span> from <span class=\"token string\">'@sakitam-gis/react-map'</span><span class=\"token punctuation\">;</span>"
      },
      [
        "code",
    ...
    [
      ...
      [
        ...
        [
          ...
          {
            "title": null,
            "href": "http://maptalks.org/maptalks.js/api/0.x/Map.html"
          },
          "查看详细使用"
        ]
      ]
...
// module
exports.push([module.i, ".map-content {\n  width: 100%;\n  height: 300px;\n}\n", ""]);
...
if(true) {
	module.hot.accept(1550, function() {
		var newContent = __webpack_require__(1550);
...
if(true) {
	module.hot.accept(1551, function() {
		var newContent = __webpack_require__(1551);
...
//# sourceMappingURL=map.md.js.map